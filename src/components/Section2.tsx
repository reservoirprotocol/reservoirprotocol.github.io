...
const Section2 = () => {
  return (
    <motion.div className="mx-auto mb-40 flex max-w-screen-xl flex-col-reverse place-items-center gap-14 px-4 md:mb-56 md:grid md:grid-cols-2 md:gap-28 lg:px-2"
    initial={{x: '-50'}}
    whileInView={{x: 0}}
